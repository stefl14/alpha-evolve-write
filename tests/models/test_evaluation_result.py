...
class TestEvaluationResultModel:
    ...
    def test_evaluation_result_creation_with_minimal_fields_succeeds(self):
        ...
        essay_id = uuid4()
        result = EvaluationResult(essay_id=essay_id, overall_score=85.5)
    ...
    def test_evaluation_result_criteria_scores_validation_accepts_valid_scores(self):
        ...
        essay_id = uuid4()
        criteria_scores = {"coherence": 0.0, "grammar": 50.5, "style": 100.0}

        result = EvaluationResult(
            essay_id=essay_id, overall_score=50.0, criteria_scores=criteria_scores
        )
        assert result.criteria_scores == criteria_scores
    ...
    def test_evaluation_result_criteria_scores_validation_rejects_invalid_scores(self):
        ...
        with pytest.raises(
            ValueError, match="All criteria scores must be between 0 and 100"
        ):
            EvaluationResult(
                essay_id=essay_id,
                overall_score=50.0,
    ...
    def test_evaluation_result_computed_average_score_calculation(self):
        ...
        essay_id = uuid4()
        criteria_scores = {"coherence": 80.0, "grammar": 90.0, "style": 70.0}

        result = EvaluationResult(
            essay_id=essay_id, overall_score=85.0, criteria_scores=criteria_scores
        )
