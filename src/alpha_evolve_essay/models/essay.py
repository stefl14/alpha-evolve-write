...
class Essay(BaseModel):
    ...
    id: UUID = Field(default_factory=uuid4, description="Unique identifier for the essay")
    content: str = Field(..., description="The essay content text")
    prompt: str = Field(..., description="The original prompt used to generate this essay")
    ...
    parent_id: Optional[UUID] = Field(default=None, description="ID of parent essay if this is a variation")
